        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <button
              ...
              onClick={() => handleNavigation("/ReportLeaderboard")}
            >
              View
            </button>
          </div>
          ...
          {/* Campaigns */}
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">Call Report</h2>
          ...
          {/* Reports */}
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">Lead Report</h2>
